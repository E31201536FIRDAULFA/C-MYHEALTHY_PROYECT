  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-between">
      ...
      <div class="d-none d-lg-flex social-links align-items-center">
        <a href="https://www.twitter.com/CMyhealthy" class="twitter"><i class="bi bi-twitter"></i></a>
        <a href="https://www.facebook.com/profile.php?id=100075510356356" class="facebook"><i class="bi bi-facebook"></i></a>
        <a href="https://instagram.com/clickmyhealthy?utm_medium=copy_link" class="instagram"><i class="bi bi-instagram"></i></a>
          <a class="nav-link" href="db_petugas.php">Back</a>
