...
<br><br><br><br>
    <div class="jumbotron">
      <div class="container">
        ...
        <a class="btn btn-primary btn-lg" href="tambah_gigi.php" role="button">Tambah Data</a>
        <a class="btn btn-primary btn-lg" href="cetak-gigi.php" role="button">Cetak Laporan Data</a>
      </div>
    </div>
</head>
