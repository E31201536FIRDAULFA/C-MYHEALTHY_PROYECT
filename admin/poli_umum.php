...
<title>C-Myhealthy | Poli Umum</title>
...
<body id="page-top" class="h-100">
    ...
    <div class="container">
    <a class="navbar-brand" href="#page-top"><b>HALAMAN POLI UMUM</a></b>
...
$nmr = 1;
        ...
        <tr>
          ...
          <td><a href="hapus-umum.php?NIK=<?=$data['NIK'];?>" class="btn btn-danger" onclick="return confirm('yakin anda akan menghapus data ini?');">Hapus</a></td>   
            <td><a href=""><button class="btn btn-primary"><i class="fa fa-print"></i>Cetak</button></a></td>
        </tr>
        <?php $nmr++;?>
        <?php endwhile; ?>
